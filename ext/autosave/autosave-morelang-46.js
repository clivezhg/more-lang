...
( function( $, window ) {
	function autosave() {
		...
		function getPostData( type ) {
			...
			if ( window.morelang && window.morelang.getPostDataHack ) {
				window.morelang.getPostDataHack( data );
			}
		...
		function getCompareString( postData ) {
			if ( window.morelang && window.morelang.getCompareStringHack ) {
				return window.morelang.getCompareStringHack( postData );
			}
